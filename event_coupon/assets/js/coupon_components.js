...
const cpItem = Vue.component('cpItem',{
  ...
  data(){
		return {
			items: [
			    { id: 1, src:'event_coupon/images/img-sb.png', title: '스타필드가면 시원한 스타벅스 아메리카노 20% 할인',date:'2019년 8월 31일까지' },
			    { id: 2, src:'images/img-sb.png', title: '스타필드가면 시원한 스타벅스',date:'2019년 10월 20일까지'},
			    { id: 3, src:'images/img-sb.png', title: '스타필드가면 시원한',date:'2022년 8월 31일까지' }
			],
